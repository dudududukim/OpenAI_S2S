...
const startBtn = document.getElementById('start') as HTMLButtonElement;   // Type Annotation "as"
const stopBtn = document.getElementById('stop') as HTMLButtonElement;
const logEl = document.getElementById('log') as HTMLPreElement;

let session: RealtimeSession | null = null;   // Type Annotation ":"
...
startBtn.onclick = async () => {
  ...
  // events types of realtimesession: https://openai.github.io/openai-agents-js/openai/agents/realtime/type-aliases/realtimesessioneventtypes/
